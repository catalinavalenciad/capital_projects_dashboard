...
-- Query 1: Row count verification across all tables
...
-- Query 2: Budget variance by project
SELECT
    p.project_id,
    p.project_name,
    p.location,
...
-- Query 3: Change order cost impact by project
SELECT
    p.project_id,
    p.project_name,
...
-- Query 4: RFI volume and average response time by project
SELECT
    p.project_id,
    p.project_name,
...
-- Query 5: Change event breakdown by type and reason
SELECT
    event_type,
    reason,
...
-- Query 6: Submittal status summary by project
SELECT
    p.project_id,
    p.project_name,
...
-- Query 7: Planned vs actual spend over time by project
SELECT
    p.project_name,
    bt.period_date,
    bt.planned_spend,
